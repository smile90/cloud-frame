...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    // fastjson autoType配置
    {
        ParserConfig.getGlobalInstance().addAccept("com.frame.");
    }
    ...
    public CacheManager cacheManager() {
        ...
        RedisSerializationContext.SerializationPair<Object> valueSerializer = RedisSerializationContext.SerializationPair.fromSerializer(new FastJson2JsonRedisSerializer());
        // 默认缓存配置
