...
public class CorsFilter extends GenericFilterBean {
    ...
    public void corf(HttpServletRequest request,HttpServletResponse response) {
        ...
        Optional.ofNullable(corsProperties.getAllowOrigin()).ifPresent(origins -> {
        ...
        response.setHeader("Access-Control-Allow-Methods", corsProperties.getAllowMethod());
        response.setHeader("Access-Control-Allow-Headers", corsProperties.getAllowHeader());
